    ...
    return (
        <main className={styles.main}>
            <div className="container">
                ...
                <div className="map"><a href="/images/common/sunset-forest-phase1a.jpg" target="_blank" title="Sunset Forest Map | CRAGS.HK"><img src="/images/common/sunset-forest-phase1a.jpg" /></a></div>
